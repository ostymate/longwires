 ...
 * @warning It's blocking!
 * Be careful when use it with slow devices or long wires,
 * as it may block for a long time until timeout occurs.
 *
 * Features:
 ...
 * @param sda_pin SDA pin (any pin that supports open drain configuration)
